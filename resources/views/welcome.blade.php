<x-app-layout>
    ...
    <div class="bg-gradient-to-r from-red-50 to-indigo-50 px-6 shadow-sm py-10 sm:py-20 text-center text-neutral-800 dark:bg-neutral-700 dark:text-neutral-200">
        ...
        <div class="text-center mx-auto lg:w-1/2">
            <h3 class="text-sm font-sans ">SoftwareJobs in best place to search and post jobs for both proffessionals and employers.we have quality and trusted opportunities, Let's start a career with us</h3>
        </div>

        <div class="text-center mx-auto lg:w-1/2">
            <h3 class="mb-8 mt-3 text-blue-900 text-xs font-sans ">" Keep trying until you achieve it. "</h3>
        </div>
