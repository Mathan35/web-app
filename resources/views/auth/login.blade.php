            ...
            <div class="h-full">
                ...
                <div class="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between">
                    ...
                    <div class="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
                        <h2 class="text-md font-sans text-center text-gray-800 font-semibold">Login </h2>
                        <!-- Email input -->
                        <div class="my-6">
                        ...
                        <div class="text-center lg:text-left">
                            ...
                            <p class="mb-0 mt-2 pt-1 text-sm font-semibold">
                                ...
                                <a href="/register" class="text-danger transition duration-150 ease-in-out hover:text-danger-600 focus:text-danger-600 active:text-danger-700">Register</a>
                            </p>
                        </div>
                    </div>
                </div>
