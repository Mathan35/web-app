        ...
        <main>
            <div class="" id="content">
                <div class="flex items-center bg-white px-4 py-3 justify-between shadow-lg">
                    <!-- Toggler -->
                    <button class="inline-block rounded bg-primary px-6 py-2.5 text-xs font-medium uppercase leading-tight text-white shadow-md transition duration-150 ease-in-out hover:bg-primary-700 hover:shadow-lg focus:bg-primary-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-primary-800 active:shadow-lg" data-te-sidenav-toggle-ref data-te-target="#sidenav-2" aria-controls="#sidenav-2" aria-haspopup="true">
                    ...
                    <div class="flex space-x-1 items-center">
                        <p class="text-sm font-semibold font-sans text-gray-700">Admin Panel</p>
                        <div class="">
