<div class="max-w-5xl mx-auto px-2 sm:px-0">
    ...
    <div class="font-regular relative block w-full rounded-lg bg-green-500 px-4 py-4  my-3 text-base text-white" data-dismissible="alert">
    ...
    <form action="{{route('store-employee-request')}}" method="post" enctype="multipart/form-data">
        ...
        <div class=" bg-white shadow-sm rounded-md my-10 py-10 px-5 space-y-4">
            ...
            <div class="sm:flex items-center sm:space-y-0 space-y-2">
                ...
                <input name='job_title' placeholder="Full stack developer ( Mern )" class="border border-gray-200 rounded-md w-full py-1 px-2 font-sans focus:border-gray-400 focus:outline-none" type="text" id="">
            </div>
            @error('job_title')
            <div class="alert alert-danger text-xs text-red-600">{{ $message }}</div>
            @enderror
            <div class="sm:flex items-center sm:space-y-0 space-y-2">
                <label class="text-md text-gray-700 font-bold font-sans w-full sm:w-52" for="">Company Name</label>
                <input name='company_name' placeholder="Amazon" class="border border-gray-200 rounded-md w-full py-1 px-2 font-sans focus:border-gray-400 focus:outline-none" type="text" id="">
            </div>
            ...
            <div class=" border border-gray-300 rounded-md py-4 px-3">
                <div class="sm:flex sm:space-y-0 space-y-2">
                    <label class="text-md text-gray-700 font-bold font-sans w-full sm:w-52" for="">Job details</label>
                    <textarea name="content" id="editor" class="border border-gray-200 mt-3 sm:mt-0 rounded-md w-full py-1 px-2 font-sans focus:border-gray-400 focus:outline-none" rows="4" id=""></textarea>
                </div>
            ...
            <div class="sm:flex items-center sm:space-y-0 space-y-2">
                ...
                <input name='category' class="border border-gray-200 rounded-md w-full py-1 px-2 font-sans focus:border-gray-400 focus:outline-none" type="text" id="" placeholder="Ex,.. front end developer">
            </div>
            @error('category')
            <div class="alert alert-danger text-xs text-red-600">{{ $message }}</div>
            @enderror
            ...
            <div class="sm:flex sm:space-y-0 space-y-2">
                <label class="text-md text-gray-700 font-bold font-sans w-full sm:w-52" for="">Salary ( optional )</label>
                <div>
                    <input name='salary' class="border border-gray-200 rounded-md w-full py-1 px-2 font-sans focus:border-gray-400 focus:outline-none" type="text" id="">
                    <p class="text-xs text-gray-600 font-sans mt-2">Examples: "$120,000 – $145,000 USD", "€80,000 — €102,000"</p>
                </div>
            </div>
            @error('salary')
            <div class="alert alert-danger text-xs text-red-600">{{ $message }}</div>
            ...
            <div class="sm:flex sm:space-y-0 space-y-2">
                <label class="text-md text-gray-700 font-bold font-sans w-full sm:w-52" for="">Experience</label>
            ...
            <div class="border border-gray-200 rounded-md py-3 px-2">
                <h2 class="text-md font-sans font-semibold text-center">Enhance Your Job Listing</h2>
            ...
            <div class="sm:flex ">
                <label class="text-md text-gray-700 font-bold font-sans w-full sm:w-52" for="">Company Logo ( optional )</label>
                <div class="mb-3">
            ...
            <div class="border border-hray-300 rounded-md px-4 py-4">
                ...
                <div>
                    ...
                    <x-text-input id="name" class="block mt-1 w-full focus:outline-none border focus:border-gray-400" type="text" name="name" :value="old('name')" autofocus autocomplete="name" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="email" class="block mt-1 w-full focus:outline-none border focus:border-gray-400" type="email" name="email" :value="old('email')" autocomplete="username" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="password" class="block mt-1 w-full focus:outline-none border focus:border-gray-400" type="password" name="password" autocomplete="new-password" />
